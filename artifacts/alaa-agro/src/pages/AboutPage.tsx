...
const commitments = [
  {
    ...
    ar: {
      title: 'المواصفات تُعتمد كتابياً قبل تأكيد أي طلب',
      detail: 'تُقدَّم نسب الرطوبة والبروتين والغلوتين والشوائب والرماد في مرحلة الاستفسار — لا بعد الدفع. وإذا لم تطابق دفعة المحصول المعايير المتفق عليها، فإننا لا نشحنها.',
    },
  },
  {
    en: {
    ...
    ar: {
      title: 'شهادات صحة نباتية وجودة مطابقة لمعيار GOST مع كل شحنة',
      detail: 'تتوافق جميع السلع مع المعايير الحكومية الفيدرالية الروسية. ويُعد الملف الكامل للمستندات — شهادة الصحة النباتية وشهادة الجودة وشهادة المنشأ — ويُقدَّم بشكل قياسي.',
    },
  },
  {
    en: {
    ...
    ar: {
      title: 'تعبئة ووسم بمقاسات تلائم سوق الوصول',
      detail: 'أكياس بولي بروبيلين منسوجة تحمل علامتنا بسعة 25 و50 كجم، أو أكياس FIBC كبيرة، أو حمولات صب في الحاويات. وتُعد لغة الملصق وبيانات الوزن الصافي وإقرارات بلد المنشأ وفق متطلبات الاستيراد لديكم.',
    },
  },
  {
    en: {
    ...
    ar: {
      title: 'FOB وCFR وCIF وDAP — نقدّم العرض وفق شرط التسليم الذي يناسب مينائكم',
      detail: 'ننسّق الشحن البحري من نوفوروسيسك وتامان وغيرها من موانئ البحر الأسود وبحر البلطيق. وتتوفر خيارات النقل بالسكك الحديدية والطرق البرية للدول غير الساحلية في آسيا الوسطى والقوقاز.',
    },
  },
  {
    en: {
    ...
    ar: {
      title: 'مسؤول تواصل واحد من أول استفسار حتى تأكيد التسليم',
      detail: 'بلا أنظمة تذاكر وبلا تنقّل بين الأقسام. مسؤولكم متاح مباشرة عبر واتساب أو البريد الإلكتروني ويتولى كل خطوة: العقد والدفع والتحميل والمستندات والتسليم النهائي.',
    },
  },
  {
    en: {
    ...
    ar: {
      title: 'المشترون المتكررون يحصلون على أولوية التخصيص في مواسم شحّ المعروض',
      detail: 'عند محدودية المعروض الموسمي، تُعرض الدفعات المتاحة على المشترين الدائمين أولاً. وتُكافأ الالتزامات الثابتة بالكميات بنوافذ تسعير ثابتة ومواعيد تحميل محفوظة.',
    },
  },
];

const stats = [
  { en: 'Products in catalogue', ru: 'Продуктов в каталоге', ar: 'منتجات في الكتالوج', value: '15+' },
  { en: 'Packaging formats', ru: 'Форматов упаковки', ar: 'صيغ التعبئة', value: '5' },
  { en: 'Export destinations', ru: 'Направлений экспорта', ar: 'أسواق التصدير', value: '20+' },
  { en: 'Incoterms offered', ru: 'Условий Инкотермс', ar: 'شروط إنكوترمز المتاحة', value: 'FOB · CFR · CIF · DAP' },
];
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((s, i) => (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wide">{s[locale]}</p>
              </motion.div>
            ))}
          </div>
        </div>
